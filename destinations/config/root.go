...
type Configer interface {
	DestType() destinations.DestinationType
...
func CalculateWithBase(currentConfig *Config,
	...
	for _, dest := range dests {
		...
		routingProcessor, exists := sourcesFilterProcessors[sanitizedProcessorName]
		if exists {
...
func LoadConfigers() (map[destinations.DestinationType]Configer, error) {
	configers := map[destinations.DestinationType]Configer{}
