ARG ODIGLET_BASE_IMAGE=p0xd21zf5r.registry.depot.dev/odigos/odiglet-base:v1.16
...
COPY --from=public.ecr.aws/odigos/agents/nodejs-community:v0.11.0 /instrumentations/nodejs-community /instrumentations/nodejs-community
# nodejs-community-14
