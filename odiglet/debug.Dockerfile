...
# NodeJS
COPY --from=public.ecr.aws/odigos/agents/nodejs-community:v0.0.14 /instrumentations/opentelemetry-node /instrumentations/opentelemetry-node
COPY --from=public.ecr.aws/odigos/agents/nodejs-community:v0.0.14 /instrumentations/nodejs-community /instrumentations/nodejs-community
