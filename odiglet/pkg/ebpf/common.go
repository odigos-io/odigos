...
func NewManager(client client.Client, logger logr.Logger, opts InstrumentationManagerOptions, configUpdates <-chan instrumentation.ConfigUpdate[K8sConfigGroup], instrumentationRequests <-chan instrumentation.InstrumentationRequest[K8sProcessDetails],
