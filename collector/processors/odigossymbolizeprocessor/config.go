...
type Config struct {
	...
	// MaxMemoryBytes bounds the processor's total memory: the retained symbol
	// cache gets it in full, the transient per-binary symtab decode gets a
	// fraction of it (see symtabDecodeCostFactor). 0 = default (256 MiB).
