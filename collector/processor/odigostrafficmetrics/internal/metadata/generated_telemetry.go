...
func Meter(settings component.TelemetrySettings) metric.Meter {
	return settings.MeterProvider.Meter("github.com/odigos-io/odigos/collector/processor/odigostrafficmetrics")
}

func Tracer(settings component.TelemetrySettings) trace.Tracer {
	return settings.TracerProvider.Tracer("github.com/odigos-io/odigos/collector/processor/odigostrafficmetrics")
}
