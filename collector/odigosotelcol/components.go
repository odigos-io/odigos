...
func components() (otelcol.Factories, error) {
	...
	factories.ExtensionModules = makeModulesMap(factories.Extensions, map[component.Type]string{
		...
		googleclientauthextension.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/extension/googleclientauthextension v0.158.0",
		...
		odigosconfigk8sextension.NewFactory().Type(): "github.com/odigos-io/odigos/collector/extension/odigosconfigk8sextension v0.158.0",
		odigoscapabilitiesextension.NewFactory().Type(): "github.com/odigos-io/odigos/collector/extension/odigoscapabilitiesextension v0.158.0",
	})
	...
	factories.ExporterModules = makeModulesMap(factories.Exporters, map[component.Type]string{
		...
		azureblobstorageexporter.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/odigos/exporter/azureblobstorageexporter v0.158.0",
		googlecloudstorageexporter.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/odigos/exporter/googlecloudstorageexporter v0.158.0",
		mockdestinationexporter.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/odigos/exporter/mockdestinationexporter v0.158.0",
		awscloudwatchlogsexporter.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/exporter/awscloudwatchlogsexporter v0.158.0",
		awsemfexporter.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/exporter/awsemfexporter v0.158.0",
		awss3exporter.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/exporter/awss3exporter v0.158.0",
		awsxrayexporter.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/exporter/awsxrayexporter v0.158.0",
		azuredataexplorerexporter.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/exporter/azuredataexplorerexporter v0.158.0",
		azuremonitorexporter.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/exporter/azuremonitorexporter v0.158.0",
		clickhouseexporter.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/exporter/clickhouseexporter v0.158.0",
		cassandraexporter.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/exporter/cassandraexporter v0.158.0",
		coralogixexporter.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/exporter/coralogixexporter v0.158.0",
		datadogexporter.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/exporter/datadogexporter v0.158.0",
		datasetexporter.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/exporter/datasetexporter v0.158.0",
		elasticsearchexporter.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/exporter/elasticsearchexporter v0.158.0",
		...
		googlecloudpubsubexporter.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/exporter/googlecloudpubsubexporter v0.158.0",
		googlemanagedprometheusexporter.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/exporter/googlemanagedprometheusexporter v0.158.0",
		honeycombmarkerexporter.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/exporter/honeycombmarkerexporter v0.158.0",
		influxdbexporter.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/exporter/influxdbexporter v0.158.0",
		...
		logicmonitorexporter.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/exporter/logicmonitorexporter v0.158.0",
		logzioexporter.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/exporter/logzioexporter v0.158.0",
		mezmoexporter.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/exporter/mezmoexporter v0.158.0",
		opensearchexporter.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/exporter/opensearchexporter v0.158.0",
		...
		pulsarexporter.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/exporter/pulsarexporter v0.158.0",
		sentryexporter.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/exporter/sentryexporter v0.158.0",
		signalfxexporter.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/exporter/signalfxexporter v0.158.0",
		splunkhecexporter.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/exporter/splunkhecexporter v0.158.0",
		sumologicexporter.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/exporter/sumologicexporter v0.158.0",
		...
		tencentcloudlogserviceexporter.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/exporter/tencentcloudlogserviceexporter v0.158.0",
	...
	factories.ProcessorModules = makeModulesMap(factories.Processors, map[component.Type]string{
		odigostailsamplingprocessor.NewFactory().Type(): "github.com/odigos-io/odigos/collector/processors/odigostailsamplingprocessor v0.158.0",
		odigostracestateprocessor.NewFactory().Type(): "github.com/odigos-io/odigos/collector/processors/odigostracestateprocessor v0.158.0",
		odigosconditionalattributes.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/odigos/processor/odigosconditionalattributes v0.158.0",
		odigossqldboperationprocessor.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/odigos/processor/odigossqldboperationprocessor v0.158.0",
		odigossqlqueryprocessor.NewFactory().Type(): "github.com/odigos-io/odigos/collector/processor/odigossqlqueryprocessor v0.158.0",
		odigospiimaskingprocessor.NewFactory().Type(): "github.com/odigos-io/odigos/collector/processor/odigospiimaskingprocessor v0.158.0",
		...
		deltatorateprocessor.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/processor/deltatorateprocessor v0.158.0",
		...
		groupbytraceprocessor.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/processor/groupbytraceprocessor v0.158.0",
		...
		metricsgenerationprocessor.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/processor/metricsgenerationprocessor v0.158.0",
		metricstransformprocessor.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/processor/metricstransformprocessor v0.158.0",
		...
		sumologicprocessor.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/processor/sumologicprocessor v0.158.0",
		...
		remotetapprocessor.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/processor/remotetapprocessor v0.158.0",
		odigostrafficmetrics.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/odigos/processor/odigostrafficmetrics v0.158.0",
		odigosurltemplateprocessor.NewFactory().Type(): "github.com/odigos-io/odigos/collector/processor/odigosurltemplateprocessor v0.158.0",
		odigoslogsresourceattrsprocessor.NewFactory().Type(): "github.com/odigos-io/odigos/collector/processor/odigoslogsresourceattrsprocessor v0.158.0",
		odigosextractattributeprocessor.NewFactory().Type(): "github.com/odigos-io/odigos/collector/processor/odigosextractattributeprocessor v0.158.0",
		odigostracefilterprocessor.NewFactory().Type(): "github.com/odigos-io/odigos/collector/processors/odigostracefilterprocessor v0.158.0",
	})
	...
	factories.ConnectorModules = makeModulesMap(factories.Connectors, map[component.Type]string{
		...
		datadogconnector.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/connector/datadogconnector v0.158.0",
		exceptionsconnector.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/connector/exceptionsconnector v0.158.0",
		routingconnector.NewFactory().Type(): "github.com/open-telemetry/opentelemetry-collector-contrib/connector/routingconnector v0.158.0",
		...
		odigosrouterconnector.NewFactory().Type(): "github.com/odigos-io/odigos/collector/connectors/odigosrouterconnector v0.158.0",
		serviceioconnector.NewFactory().Type(): "github.com/odigos-io/odigos/collector/connectors/serviceioconnector v0.158.0",
	})
