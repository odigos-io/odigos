...
type BindObjectAllocationInNewTLAB struct {
	Temp   ObjectAllocationInNewTLAB
	Fields []BindFieldObjectAllocationInNewTLAB
}
...
func NewBindObjectAllocationInNewTLAB(typ *def.Class, typeMap *def.TypeMap) *BindObjectAllocationInNewTLAB {
	...
	for i := 0; i < len(typ.Fields); i++ {
		...
		default:
			res.Fields = append(res.Fields, BindFieldObjectAllocationInNewTLAB{Field: &typ.Fields[i]}) // skip unknown new field
		}
	}
	return res
}
