...
func (r *odigosConfigController) Reconcile(ctx context.Context, _ ctrl.Request) (ctrl.Result, error) {
	...
	err = r.handleGoOffsetsCronJob(ctx, &odigosConfig, env.GetCurrentNamespace())
	if err != nil {
		return ctrl.Result{}, err
	}
...
func (r *odigosConfigController) handleGoOffsetsCronJob(ctx context.Context, config *common.OdigosConfiguration, ns string) error {
