...
func (r *ProbabilisticSamplerReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	logger.Info("Reconciling ProbabilisticSampler action")
	logger.Info("WARNING: ProbabilisticSampler action is deprecated and will be removed in a future version. Migrate to odigosv1.Action instead.")
