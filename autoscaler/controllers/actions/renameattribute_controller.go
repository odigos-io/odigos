...
func (r *RenameAttributeReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	logger.Info("Reconciling RenameAttribute action")
	logger.Info("WARNING: RenameAttribute action is deprecated and will be removed in a future version. Migrate to odigosv1.Action instead.")
