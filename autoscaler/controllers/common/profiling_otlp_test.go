...
func TestK8sAttributesProfilesProcessorConfigExtractsWorkloadMetadata(t *testing.T) {
...
func TestProfilingServiceNameTransformConfigUsesWorkloadMetadata(t *testing.T) {
