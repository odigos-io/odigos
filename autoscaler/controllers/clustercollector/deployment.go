...
func syncDeployment(enabledDests *odigosv1.DestinationList, gateway *odigosv1.CollectorsGroup,
	...
	desiredDeployment, err := getDesiredDeployment(ctx, c, enabledDests, configDataHash, gateway, scheme, imagePullSecrets, odigosVersion, autoScalerTopologySpreadConstraints)
	if err != nil {
