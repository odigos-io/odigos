...
func NewOdigletDaemonSet(ns string, version string, imagePrefix common.ConfigString, imageName string,
	odigosTier common.OdigosTier, openshiftEnabled common.ConfigBool, clusterDetails *autodetect.ClusterDetails, customContainerRuntimeSocketPath common.ConfigString, nodeSelector map[string]string, healthProbeBindPort common.ConfigInt) *appsv1.DaemonSet {
