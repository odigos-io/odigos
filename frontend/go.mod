...
require (
	...
	github.com/grafana/pyroscope v1.20.0
...
// Pyroscope v1.20 pulls a dskit pseudo-version incompatible with our hashicorp/memberlist; keep the prior dskit.
replace github.com/grafana/dskit => github.com/grafana/dskit v0.0.0-20250723143816-ff33c5829b96
...
replace (
	...
	// Required by github.com/grafana/pyroscope@v1.19.1 (DecodeWithOptions); matches upstream Pyroscope go.mod.
