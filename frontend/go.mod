...
// Avoid ambiguous import with github.com/ugorji/go/codec (nested vs separate module).
exclude github.com/ugorji/go v1.1.4

replace (
	// Align with github.com/grafana/pyroscope: dskit expects Grafana's memberlist fork (APIs not in upstream).
	...
	// Align with github.com/grafana/pyroscope (DecodeWithOptions on yaml.Node).
