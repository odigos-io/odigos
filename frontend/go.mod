...
require (
	...
	github.com/grafana/pyroscope v1.20.3
...
require (
	...
	github.com/hashicorp/memberlist v0.5.5-0.20260121135751-313d20ccb3ce // indirect
...
replace (
	// Match github.com/grafana/pyroscope: fork includes APIs required by grafana/dskit (NodeState, etc.)
	...
	// Pyroscope expects patched yaml.v3 (DecodeWithOptions); see grafana/pyroscope go.mod
