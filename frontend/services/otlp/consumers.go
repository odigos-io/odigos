...
import (
	...
	collectorprofiles "github.com/odigos-io/odigos/frontend/services/profiles"
...
type Consumers struct {
	...
	Profiles *collectorprofiles.OdigosProfilesConsumer
}

func NewConsumers(metrics *collectormetrics.OdigosMetricsConsumer, profiles *collectorprofiles.OdigosProfilesConsumer) *Consumers {
...
func (c *Consumers) Run(ctx context.Context, port int) {
	...
	// creating metrics and profiling receiver
