...
type InstrumentedProcess struct {
	...
	WorkloadKind      string    `gorm:"column:workload_kind; type:text; not null; check:workload_kind IN ('Deployment', 'StatefulSet', 'DaemonSet', 'CronJob', 'DeploymentConfig')"` // Kubernetes workload kind [Deployment/StatefulSet/DaemonSet/CronJob/DeploymentConfig]
