...
func OidcAuthCallback(ctx context.Context, c *gin.Context) {
	...
	// Redact the access token for security reasons
	// oauth2Token.AccessToken = "*REDACTED*"

	// Prepare the response structure.
	// Note: ID Token payload is just JSON,
	// so we use json.RawMessage to avoid unmarshalling it into a struct,
	// which would require knowing the structur of the ID Token claims in advance.
	// resp := struct {
	...
	// Extract the ID Token claims into a JSON raw message
	...
	//       "token_type": "Bearer",
	//       "expiry": "2025-06-25T14:58:58.048954+03:00",
	//       "expires_in": 3600
	//   },
	//   "IDTokenClaims": {
	//       "sub": "00usnm7ugvfZgIi3C697",
	//       "name": "Ben Elferink",
	//       "email": "ben@odigos.io",
	//       "ver": 1,
	//       "iss": "https://trial-8298548.okta.com",
	//       "aud": "0oasnm9g930ZFBXps697",
	//       "iat": 1750849137,
	//       "exp": 1750852737,
	//       "jti": "ID.7DEHzn9HTd91EJwsYwDEH3Op8HujyH31cDQIM5L1HCc",
	//       "amr": [
	//           "mfa",
	//           "otp",
	//           "phr",
	...
	//           "okta_verify"
	//       ],
	//       "idp": "00osnluyijF5ugBLY697",
	//       "nonce": "gq6G5R8ECNM_ofwTdTxfJQ",
	//       "preferred_username": "ben@odigos.io",
	//       "auth_time": 1750847446,
	//       "at_hash": "6QjUllA1ah1ZvPqfajHFeg"
	//   }
	// }
