...
// appendResourceProfileChunk extracts one resource from the batch,
// marshals it as OTLP Profiles protobuf (ExportProfilesServiceRequest wire, pdata ProtoMarshaler),
// and appends to the store slot.
