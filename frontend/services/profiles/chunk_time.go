...
// and returns the earliest Profile.TimeUnixNano as Unix seconds.
// Malformed chunks are skipped; zero timestamps are ignored. Returns 0 when no positive time is found.
