...
// RunDeleteWatcherAndNotifications runs the Kubernetes delete watcher and
// the in-process loop that applies deletion notifications to in-memory metrics maps.
