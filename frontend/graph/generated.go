...
type ComplexityRoot struct {
	...
	K8sActualSource struct {
		...
		OtelServerName    func(childComplexity int) int
		Selected          func(childComplexity int) int
	}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "K8sActualSource.otelServerName":
		if e.complexity.K8sActualSource.OtelServerName == nil {
			break
		}

		return e.complexity.K8sActualSource.OtelServerName(childComplexity), true
...
func (ec *executionContext) fieldContext_K8sActualNamespace_k8sActualSources(_ context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		...
		Child: func(ctx context.Context, field graphql.CollectedField) (*graphql.FieldContext, error) {
			...
			case "otelServerName":
				return ec.fieldContext_K8sActualSource_otelServerName(ctx, field)
			case "containers":
...
func (ec *executionContext) _K8sActualSource_otelServerName(ctx context.Context, field graphql.CollectedField, obj *model.K8sActualSource) (ret graphql.Marshaler) {
	fc, err := ec.fieldContext_K8sActualSource_otelServerName(ctx, field)
	if err != nil {
		return graphql.Null
	}
	ctx = graphql.WithFieldContext(ctx, fc)
...
func (ec *executionContext) fieldContext_K8sActualSource_otelServerName(_ context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "K8sActualSource",
		Field:      field,
		IsMethod:   false,
...
func (ec *executionContext) unmarshalInputPatchSourceRequestInput(ctx context.Context, obj interface{}) (model.PatchSourceRequestInput, error) {
	...
	fieldsInOrder := [...]string{"otelServerName"}
	for _, k := range fieldsInOrder {
		v, ok := asMap[k]
		if !ok {
			continue
...
func (ec *executionContext) _K8sActualSource(ctx context.Context, sel ast.SelectionSet, obj *model.K8sActualSource) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "otelServerName":
			out.Values[i] = ec._K8sActualSource_otelServerName(ctx, field, obj)
		case "containers":
