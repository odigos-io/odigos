...
export const ArrowIcon: SVG = ({ size = 16, fill = '#F9F9F9', rotate = 0 }) => {
  return (
    <svg width={size * (9 / 13.5)} height={size} viewBox='0 0 9 13.5' xmlns='http://www.w3.org/2000/svg' fill={fill} style={{ transform: `rotate(${rotate}deg)` }}>
