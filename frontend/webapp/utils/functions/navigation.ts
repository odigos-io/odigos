...
import { ActionIcon, DestinationIcon, InstrumentationRuleIcon, OverviewIcon, PipelineCollectorIcon, ServiceMapIcon, SourceIcon, TraceViewIcon } from '@odigos/ui-kit/icons';
...
export const getNavbarIcons = (router: AppRouterInstance, currentPath: string) => {
  const navIcons: NavbarProps['icons'] = [
    ...
    getPayloadForIcon(router, currentPath, ROUTES.PROFILING, TraceViewIcon),
  ];
