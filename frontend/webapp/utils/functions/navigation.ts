...
import { OverviewIcon, PipelineCollectorIcon, SamplingIcon, ServiceMapIcon, SettingsIcon, UrlTemplatizationIcon } from '@odigos/ui-kit/icons';
...
export const getNavbarIcons = (router: AppRouterInstance, currentPath: string) => {
  const navIcons: NavbarProps['icons'] = [
    ...
    getPayloadForIcon(router, currentPath, ROUTES.URL_TEMPLATIZATION, 'URL Templatization', UrlTemplatizationIcon),
