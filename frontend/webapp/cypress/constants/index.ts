...
export const SELECTED_ENTITIES = {
  ...
  // NOTE: ExtractAttribute is temporarily excluded because the dynamic table
  // sends `dataFormat: ""` for an unselected optional enum, which the GraphQL
  // server rejects with a 400 (PLAT-1261).
  // Re-add it here once its ticket lands.
