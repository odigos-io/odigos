  ...
  return (
    <Modal isOpen={isOpen} noOverlay={noOverlay} onClose={onDeny}>
      <Container>
        ...
        <Footer>
          <FooterButton id='approve' variant={approveButton.variant || 'primary'} onClick={onApprove}>
            {approveButton.text}
          </FooterButton>
          <FooterButton id='deny' variant={denyButton.variant || 'secondary'} onClick={onDeny}>
            {denyButton.text}
          </FooterButton>
        </Footer>
      </Container>
