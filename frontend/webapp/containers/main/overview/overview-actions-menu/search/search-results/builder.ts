...
import { type ActualDestination, type InstrumentationRuleSpec, type K8sActualSource } from '@/types';
...
export const buildSearchResults = ({
  ...
  const categories: {
    ...
    label: string;
    count: number;
    entities: InstrumentationRuleSpec[] | K8sActualSource[] | Action[] | ActualDestination[];
  }[] = [
    {
