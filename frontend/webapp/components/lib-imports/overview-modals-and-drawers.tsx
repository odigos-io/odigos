...
import { AddActionDrawer, AddDestinationDrawer, AddRuleDrawer, AddSourceDrawer, AddDestinationFormContextProvider } from '@odigos/ui-kit/containers/v2';
import {
  useActionCRUD,
  useDescribe,
...
const OverviewModalsAndDrawers = () => {
  ...
  return (
    <>
      {/* add drawers (v2) */}
      {currentModal === EntityTypes.Source && <AddSourceDrawer onClose={handleCloseModal} fetchNamespacesWithWorkloads={fetchNamespacesWithWorkloads} persistSources={persistSourcesV2} />}
      ...
      {currentModal === EntityTypes.InstrumentationRule && <AddRuleDrawer onClose={handleCloseModal} createInstrumentationRule={createInstrumentationRuleV2} />}
      {currentModal === EntityTypes.Action && <AddActionDrawer onClose={handleCloseModal} createAction={createActionV2} />}
