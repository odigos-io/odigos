...
push-workload-lifecycle-images:
	...
	docker buildx build --push --platform linux/amd64,linux/arm64 -t public.ecr.aws/odigos/java-http-client:v0.0.1 -f tests/common/services/java-http-client/Dockerfile tests/common/services/java-http-client
