...
update-otel:
	...
	$(MAKE) update-dep MODULE=go.opentelemetry.io/otel VERSION=$(STABLE_GO_VERSION)
	$(MAKE) update-dep MODULE=go.opentelemetry.io/otel/exporters/otlp/otlptrace/otlptracegrpc VERSION=$(STABLE_GO_VERSION)
