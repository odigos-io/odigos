...
var (
	...
	AllowConcurrentAgents = profiles.Profile{
	...
	FullPayloadCollectionProfile = profiles.Profile{
	...
	DbPayloadCollectionProfile = profiles.Profile{
	...
	QueryOperationDetector = profiles.Profile{
	...
	SemconvUpgraderProfile = profiles.Profile{
	...
	HostnameAsPodNameProfile = profiles.Profile{
	...
	JavaNativeInstrumentationsProfile = profiles.Profile{
	...
	JavaEbpfInstrumentationsProfile = profiles.Profile{
	...
	ProfilesMap = map[common.ProfileName]profiles.Profile{
