...
func (in *PayloadCollectionSpec) DeepCopyInto(out *PayloadCollectionSpec) {
	*out = *in
	...
	if in.HttpRequestPayloadCollectionRule != nil {
		in, out := &in.HttpRequestPayloadCollectionRule, &out.HttpRequestPayloadCollectionRule
		*out = new(HttpPayloadCollectionRule)
		(*in).DeepCopyInto(*out)
	}
	if in.HttpResponsePayloadCollectionRule != nil {
		in, out := &in.HttpResponsePayloadCollectionRule, &out.HttpResponsePayloadCollectionRule
		*out = new(HttpPayloadCollectionRule)
		(*in).DeepCopyInto(*out)
	}
	if in.DbStatementPayloadCollectionRule != nil {
		in, out := &in.DbStatementPayloadCollectionRule, &out.DbStatementPayloadCollectionRule
		*out = new(DbStatementPayloadCollectionRule)
		(*in).DeepCopyInto(*out)
	}
}
