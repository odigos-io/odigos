...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PiiCategoryConfiguration) DeepCopyInto(out *PiiCategoryConfiguration) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PiiCategoryConfiguration.
func (in *PiiCategoryConfiguration) DeepCopy() *PiiCategoryConfiguration {
	if in == nil {
		return nil
	}
	out := new(PiiCategoryConfiguration)
	in.DeepCopyInto(out)
	return out
}
...
func (in *PiiMaskingSpec) DeepCopyInto(out *PiiMaskingSpec) {
	*out = *in
	...
	if in.PiiCategoryConfigurations != nil {
		in, out := &in.PiiCategoryConfigurations, &out.PiiCategoryConfigurations
		*out = make([]PiiCategoryConfiguration, len(*in))
		copy(*out, *in)
	}
}
