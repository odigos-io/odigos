...
func (in *DestinationSpec) DeepCopyInto(out *DestinationSpec) {
	*out = *in
	...
	if in.SecretFiles != nil {
		...
		*out = make([]SecretFileConfig, len(*in))
		copy(*out, *in)
	}
	if in.EnvVars != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SecretFileConfig) DeepCopyInto(out *SecretFileConfig) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SecretFileConfig.
func (in *SecretFileConfig) DeepCopy() *SecretFileConfig {
	if in == nil {
		return nil
	}
	out := new(SecretFileConfig)
	in.DeepCopyInto(out)
	return out
}
