...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *InstrumentationConfigFilter) DeepCopyInto(out *InstrumentationConfigFilter) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new InstrumentationConfigFilter.
func (in *InstrumentationConfigFilter) DeepCopy() *InstrumentationConfigFilter {
	if in == nil {
		return nil
	}
	out := new(InstrumentationConfigFilter)
	in.DeepCopyInto(out)
	return out
}
...
func (in *InstrumentationConfigSpec) DeepCopyInto(out *InstrumentationConfigSpec) {
	*out = *in
	...
	if in.Filters != nil {
		...
		*out = make([]InstrumentationConfigFilter, len(*in))
		copy(*out, *in)
	}
}
