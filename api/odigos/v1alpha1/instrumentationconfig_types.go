...
type ContainerConfig struct {
	...
	// This field can contain free-form text that describes the reason for the instrumentation decision.
	// It is meant to be read by humans and can have high cardinality.
