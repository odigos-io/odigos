...
const (
	...
	OdigosClusterCollectorClusterRoleName        = OdigosClusterCollectorDeploymentName
	OdigosClusterCollectorClusterRoleBindingName = OdigosClusterCollectorDeploymentName
