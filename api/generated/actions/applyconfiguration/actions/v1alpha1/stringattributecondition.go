...
// StringAttributeConditionApplyConfiguration constructs a declarative configuration of the StringAttributeCondition type for use with
// apply.
func StringAttributeCondition() *StringAttributeConditionApplyConfiguration {
	return &StringAttributeConditionApplyConfiguration{}
}
...
func (b *StringAttributeConditionApplyConfiguration) WithOperation(value string) *StringAttributeConditionApplyConfiguration {
	b.Operation = &value
	return b
}
...
func (b *StringAttributeConditionApplyConfiguration) WithExpectedValue(value string) *StringAttributeConditionApplyConfiguration {
