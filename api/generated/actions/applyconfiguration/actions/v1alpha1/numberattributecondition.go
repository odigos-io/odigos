...
// NumberAttributeConditionApplyConfiguration constructs a declarative configuration of the NumberAttributeCondition type for use with
// apply.
func NumberAttributeCondition() *NumberAttributeConditionApplyConfiguration {
	return &NumberAttributeConditionApplyConfiguration{}
}
...
func (b *NumberAttributeConditionApplyConfiguration) WithOperation(value string) *NumberAttributeConditionApplyConfiguration {
	b.Operation = &value
	return b
}
...
func (b *NumberAttributeConditionApplyConfiguration) WithExpectedValue(value float64) *NumberAttributeConditionApplyConfiguration {
