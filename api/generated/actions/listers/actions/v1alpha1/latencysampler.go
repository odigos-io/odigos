...
type LatencySamplerLister interface {
	...
	List(selector labels.Selector) (ret []*actionsv1alpha1.LatencySampler, err error)
...
type latencySamplerLister struct {
	listers.ResourceIndexer[*actionsv1alpha1.LatencySampler]
}
...
func NewLatencySamplerLister(indexer cache.Indexer) LatencySamplerLister {
	return &latencySamplerLister{listers.New[*actionsv1alpha1.LatencySampler](indexer, actionsv1alpha1.Resource("latencysampler"))}
}

// LatencySamplers returns an object that can list and get LatencySamplers.
func (s *latencySamplerLister) LatencySamplers(namespace string) LatencySamplerNamespaceLister {
	return latencySamplerNamespaceLister{listers.NewNamespaced[*actionsv1alpha1.LatencySampler](s.ResourceIndexer, namespace)}
}
...
type LatencySamplerNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*actionsv1alpha1.LatencySampler, error)
