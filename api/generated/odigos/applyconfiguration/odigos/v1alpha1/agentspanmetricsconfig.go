...
// apply.
func AgentSpanMetricsConfig() *AgentSpanMetricsConfigApplyConfiguration {
	return &AgentSpanMetricsConfigApplyConfiguration{}
}
...
func (b *AgentSpanMetricsConfigApplyConfiguration) WithDimensions(values ...string) *AgentSpanMetricsConfigApplyConfiguration {
	for i := range values {
