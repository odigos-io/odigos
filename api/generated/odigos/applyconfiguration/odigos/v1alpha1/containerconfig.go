...
// apply.
func ContainerConfig() *ContainerConfigApplyConfiguration {
	return &ContainerConfigApplyConfiguration{}
}
...
func (b *ContainerConfigApplyConfiguration) WithContainerName(value string) *ContainerConfigApplyConfiguration {
	b.ContainerName = &value
	return b
}

// WithInstrumented sets the Instrumented field in the declarative configuration to the given value
// and returns the receiver, so that objects can be built by chaining "With" function invocations.
// If called multiple times, the Instrumented field is set to the value of the last call.
func (b *ContainerConfigApplyConfiguration) WithInstrumented(value bool) *ContainerConfigApplyConfiguration {
	b.Instrumented = &value
	return b
}
...
func (b *ContainerConfigApplyConfiguration) WithOtelDistroName(value string) *ContainerConfigApplyConfiguration {
