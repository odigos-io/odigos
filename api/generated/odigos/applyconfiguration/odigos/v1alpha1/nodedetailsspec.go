...
// apply.
func NodeDetailsSpec() *NodeDetailsSpecApplyConfiguration {
...
func (b *NodeDetailsSpecApplyConfiguration) WithKernelVersion(value string) *NodeDetailsSpecApplyConfiguration {
