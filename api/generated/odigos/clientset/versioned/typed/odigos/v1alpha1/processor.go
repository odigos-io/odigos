...
func (c *processors) Apply(ctx context.Context, processor *odigosv1alpha1.ProcessorApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Processor, err error) {
	if processor == nil {
...
func (c *processors) ApplyStatus(ctx context.Context, processor *odigosv1alpha1.ProcessorApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Processor, err error) {
	if processor == nil {
		return nil, fmt.Errorf("processor provided to Apply must not be nil")
	}
	patchOpts := opts.ToPatchOptions()
