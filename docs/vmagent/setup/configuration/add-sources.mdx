...
<Tabs>
  ...
  <Steps>
    ...
    <Step title="Select the source menu">
      ...
      <img 
        src="../../../images/vmagent/addsource/odictl-sources-select.png" 
    ...
    <Step title="Select a source">
      ...
      <img 
        src="../../../images/vmagent/addsource/odictl-sources-process.png" 
        alt="Select Source"
        style={{    
          width: "700px",
          height: "auto",
    ...
    <Step title="Instrument source">
      ...
      <img 
        src="../../../images/vmagent/addsource/odictl-sources-properties.png" 
    ...
    <Step title="Complete instrumentation">
      ...
      <img 
        src="../../../images/vmagent/addsource/odictl-sources-finish.png" 
      ...
      <img 
        src="../../../images/vmagent/addsource/odictl-sources-end.png" 
