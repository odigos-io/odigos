---
title: "Adding Destinations"
sidebarTitle: "Adding Destinations"
...
<Tabs>
  ...
  <Steps>
    ...
    <Step title="Select the destination menu">
      ...
      <img 
        src="../../../images/vmagent/adddestination/odictl-destination-select.png" 
    ...
    <Step title="Select a destination">
      ...
      <img 
        src="../../../images/vmagent/adddestination/odictl-destination-type.png" 
    ...
    <Step title="Configure destination">
      ...
      <Frame caption="Example of an [OTLP http](../../../enterprise/backends-overview) destination">
        <img 
          src="../../../images/vmagent/adddestination/odictl-destination-configure.png" 
    ...
    <Step title="Finish adding the destination">
      ...
      <img 
        src="../../../images/vmagent/adddestination/odictl-destination-finish.png" 
      ...
      <img 
        src="../../../images/vmagent/adddestination/odictl-destination-end.png" 
