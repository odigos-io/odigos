...
### Installing the license token for the vm-agent

Write the license token received from the Odigos support team to the file `/etc/odigos-vmagent/license.jwt`
```shell
echo "<license-token>" | sudo tee /etc/odigos-vmagent/license.jwt
```
