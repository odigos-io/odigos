...
- **PROMETHEUS_USE_AUTHENTICATION** `boolean` : Use Authentication. Enable this checkbox if your Prometheus remote write endpoint requires authentication
  - This field is optional
  - Default: `false`
  ...
  <Step>
    ...
    spec:
      data:
        ...
        # PROMETHEUS_USE_AUTHENTICATION: "true"  # Enable authentication
    ...
    # You can use either Bearer Token or Basic Auth (Basic Auth takes precedence if both are provided).
    # apiVersion: v1
    # data:
