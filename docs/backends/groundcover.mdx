...
{/*
    ...
    [![logo with clickable link](https://d15jtxgb40qetw.cloudfront.net/groundcover.svg)](https://www.google.com/search?q=groundcover)

    !! Do not remove this comment, this acts as a key indicator in `docs/sync-dest-doc.py` !!
    !! START CUSTOM EDIT !!
*/}

<img src='https://d15jtxgb40qetw.cloudfront.net/groundcover.svg' alt='groundcover' width="100" height="100" className="not-prose" />
