...
- **CLICKHOUSE_CA_PEM** `string` : Certificate Authority. When using TLS, provide the CA certificate in PEM format to verify the server. If empty uses system root CA
  - This field is optional
  - Example: `-----BEGIN CERTIFICATE-----`
- **CLICKHOUSE_CERT_PEM** `string` : Client Certificate. Client TLS certificate in PEM format for mTLS authentication
  - This field is optional
  - Example: `-----BEGIN CERTIFICATE-----`
- **CLICKHOUSE_KEY_PEM** `string` : Client Private Key. Client TLS private key in PEM format for mTLS authentication
  - This field is optional
  ...
  <Step>
    ...
    spec:
      data:
        ...
        # CLICKHOUSE_CA_PEM: <Certificate Authority>
        # CLICKHOUSE_CERT_PEM: <Client Certificate>
    ...
    # apiVersion: v1
    # data:
    #   CLICKHOUSE_KEY_PEM: <Base64 Client Private Key>
