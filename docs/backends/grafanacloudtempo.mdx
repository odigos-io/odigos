...
{/*
    ...
    [![logo with clickable link](https://d15jtxgb40qetw.cloudfront.net/grafana.svg)](https://www.google.com/search?q=grafanacloudtempo)

    !! Do not remove this comment, this acts as a key indicator in `docs/sync-dest-doc.py` !!
    !! START CUSTOM EDIT !!
*/}

<img src='https://d15jtxgb40qetw.cloudfront.net/grafana.svg' alt='grafanacloudtempo' width="100" height="100" className="not-prose" />
...
Notice: these instructions are for the Grafana cloud **managed** Tempo service. If you run a self hosted Tempo, please follow the instructions in the [Tempo](/backends/tempo) page.
