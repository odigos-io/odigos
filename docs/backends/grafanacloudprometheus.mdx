...
{/*
    ...
    [![logo with clickable link](https://d15jtxgb40qetw.cloudfront.net/grafana.svg)](https://www.google.com/search?q=grafanacloudprometheus)
...
Notice: these instructions are for the Grafana cloud **managed** Prometheus service. If you run a self hosted Prometheus instance, please follow the instructions in the [Prometheus](/backends/prometheus) page.
