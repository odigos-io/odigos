...
{/*
    ...
    [![logo with clickable link](https://d15jtxgb40qetw.cloudfront.net/grafana.svg)](https://www.google.com/search?q=grafanacloudloki)
...
Notice: these instructions are for the Grafana cloud **managed** Loki service. If you run a self hosted Loki instance, please follow the instructions in the [Loki](/backends/loki) page.
