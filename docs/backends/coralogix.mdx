...
{/*
    ...
    [![logo with clickable link](https://d15jtxgb40qetw.cloudfront.net/coralogix.svg)](https://www.google.com/search?q=coralogix)
...
Get an [API Key](https://coralogix.com/docs/send-your-data-api-key/). Obtain the [Domain](https://coralogix.com/docs/coralogix-domain/) determined by your Coralogix Account URL. And follow the [Application and Subsystem Names guide](https://coralogix.com/docs/application-and-subsystem-names/) to learn how configure the application and subsystem names for your Coralogix account.
