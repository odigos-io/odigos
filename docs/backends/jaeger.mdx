...
- **JAEGER_CA_PEM** - Certificate Authority in PEM format. This is required only if Jaeger requires server authentication (TLS), if not provided, the system CA will be used.
