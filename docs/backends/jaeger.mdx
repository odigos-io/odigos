...
{/*
    ...
    [![logo with clickable link](https://d15jtxgb40qetw.cloudfront.net/jaeger.svg)](https://www.google.com/search?q=jaeger)

    !! Do not remove this comment, this acts as a key indicator in `docs/sync-dest-doc.py` !!
    !! START CUSTOM EDIT !!
*/}

<img src='https://d15jtxgb40qetw.cloudfront.net/jaeger.svg' alt='jaeger' width="100" height="100" className="not-prose" />
