...
If you run a self hosted Prometheus instance, please follow the instructions in the [Promethues](/backends/prometheus) page.
...
<Frame>
    <img src="/backends/images/grafanacloud3.png" alt="Promethues managed service configuration" />
</Frame>

To send metrics to Grafana Cloud Prometheus, you need to configure the following settings:

- **Prometheus Remote Write Endpoint** - This is the URL of the Promethues service. 
From the grafana cloud UI, Promethues page, make sure you copy the URL from "Remote Write Endpoint" section,
...
- **Username / Instance ID** - You can find the promethues page.
