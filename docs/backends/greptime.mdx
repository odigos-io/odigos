...
- **GREPTIME_ENDPOINT** `string` : OTLP HTTP Endpoint. Do not include the path `/v1/otlp/v1/metrics`.
  - This field is required
  - Example: `https://<unique_id>.<aws_region>.aws.greptime.cloud`
- **GREPTIME_DB_NAME** `string` : Database Name.
  - This field is required
- **GREPTIME_BASIC_TOKEN** `string` : Basic Auth Token. The format is `username:password`.
  - This field is required
  - Example: `xxxxx:xxxxx`
