---
title: 'Splunk'
description: 'Configuring the Splunk backend (Managed)'
sidebarTitle: 'Splunk'
icon: 'signal-stream'
---
...
{/*
    ...
    [![logo with clickable link](https://d15jtxgb40qetw.cloudfront.net/splunk.svg)](https://www.google.com/search?q=splunk)

    !! Do not remove this comment, this acts as a key indicator in `docs/sync-dest-doc.py` !!
    !! START CUSTOM EDIT !!
*/}

<img src='https://d15jtxgb40qetw.cloudfront.net/splunk.svg' alt='splunk' width="100" height="100" className="not-prose" />
