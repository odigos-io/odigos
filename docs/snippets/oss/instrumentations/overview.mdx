<Info>
  These docs are only for **Odigos Open Source**. For Enterprise installation, configuration, and features, visit the [Odigos Enterprise docs](https://enterprise.docs.odigos.io). Sign in with your enterprise API key.
</Info>
