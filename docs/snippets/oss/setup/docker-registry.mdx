...
```bash
docker pull p0xd21zf5r.registry.depot.dev/odigos/odigos-scheduler:$VERSION
docker pull p0xd21zf5r.registry.depot.dev/odigos/odigos-instrumentor:$VERSION
docker pull p0xd21zf5r.registry.depot.dev/odigos/odigos-ui:$VERSION
docker pull p0xd21zf5r.registry.depot.dev/odigos/odigos-autoscaler:$VERSION
docker pull p0xd21zf5r.registry.depot.dev/odigos/odigos-odiglet:$VERSION
docker pull p0xd21zf5r.registry.depot.dev/odigos/odigos-collector:$VERSION
docker pull p0xd21zf5r.registry.depot.dev/odigos/odigos-victoria-metrics:$VERSION
```
...
```bash
docker pull p0xd21zf5r.registry.depot.dev/odigos/odigos-agents:$VERSION
```
...
```
docker pull p0xd21zf5r.registry.depot.dev/odigos/cli-offsets:latest
```
...
```bash
docker pull --platform $PLATFORM p0xd21zf5r.registry.depot.dev/odigos/odigos-scheduler:$VERSION
docker pull --platform $PLATFORM p0xd21zf5r.registry.depot.dev/odigos/odigos-instrumentor:$VERSION
docker pull --platform $PLATFORM p0xd21zf5r.registry.depot.dev/odigos/odigos-ui:$VERSION
docker pull --platform $PLATFORM p0xd21zf5r.registry.depot.dev/odigos/odigos-autoscaler:$VERSION
docker pull --platform $PLATFORM p0xd21zf5r.registry.depot.dev/odigos/odigos-odiglet:$VERSION
docker pull --platform $PLATFORM p0xd21zf5r.registry.depot.dev/odigos/odigos-collector:$VERSION
docker pull --platform $PLATFORM p0xd21zf5r.registry.depot.dev/odigos/odigos-victoria-metrics:$VERSION
```
...
```bash
docker tag p0xd21zf5r.registry.depot.dev/odigos/odigos-scheduler:$VERSION $CUSTOM_DOCKER_REGISTRY/odigos-scheduler:$VERSION
docker tag p0xd21zf5r.registry.depot.dev/odigos/odigos-instrumentor:$VERSION $CUSTOM_DOCKER_REGISTRY/odigos-instrumentor:$VERSION
docker tag p0xd21zf5r.registry.depot.dev/odigos/odigos-ui:$VERSION $CUSTOM_DOCKER_REGISTRY/odigos-ui:$VERSION
docker tag p0xd21zf5r.registry.depot.dev/odigos/odigos-autoscaler:$VERSION $CUSTOM_DOCKER_REGISTRY/odigos-autoscaler:$VERSION
docker tag p0xd21zf5r.registry.depot.dev/odigos/odigos-odiglet:$VERSION $CUSTOM_DOCKER_REGISTRY/odigos-odiglet:$VERSION
docker tag p0xd21zf5r.registry.depot.dev/odigos/odigos-collector:$VERSION $CUSTOM_DOCKER_REGISTRY/odigos-collector:$VERSION
docker tag p0xd21zf5r.registry.depot.dev/odigos/odigos-collector:$VERSION $CUSTOM_DOCKER_REGISTRY/odigos-victoria-metrics:$VERSION
```
