...
Custom instrumentation and Go offset management are documented in the [Odigos Enterprise Go guide](https://enterprise.docs.odigos.io/enterprise/instrumentations/golang/ebpf). Sign in with a valid enterprise API key.
