...
First make sure you have a running installation of Odigos on a local k3d cluster.
...
This command will replace the running Odiglet binary and run it in a container on the k3d cluster.
<Note>
