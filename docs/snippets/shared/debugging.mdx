...
First make sure you have a running installation of Odigos on a local k0s cluster.
...
This command will replace the running Odiglet binary and run it in a container on the k0s cluster.
<Note>
