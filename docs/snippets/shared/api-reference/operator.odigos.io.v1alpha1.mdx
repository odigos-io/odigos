...
<tr>
<td>
<code>logLevel</code> <B>[Required]</B>
</td>
<td>
<code>string</code>
</td>
<td>
   <p>(Optional) LogLevel sets the default log level for all Odigos components (e.g. autoscaler, odiglet, scheduler).
Accepted values: debug, info, warn, error. Default=info when unset.</p>
</td>
</tr>
<tr>
<td>
