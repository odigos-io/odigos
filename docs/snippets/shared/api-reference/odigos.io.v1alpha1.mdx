...
<tr>
<td>
<code>-</code> <B>[Required]</B>
</td>
<td>
<code>bool</code>
</td>
<td>
   <p>In-memory only (not persisted to CRD). Set during runtime detection when
multiple programming languages are found in the same container.</p>
</td>
</tr>
<tr>
<td>
