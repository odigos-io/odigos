...
<tr>
<td>
<code>customProbes</code> <B>[Required]</B>
</td>
<td>
<a href="https://pkg.go.dev/github.com/odigos-io/odigos/common/api/instrumentationrules#CustomProbeReport"><code>common/api/instrumentationrules.CustomProbeReport</code></a>
</td>
<td>
   <span class="text-muted">No description provided.</span>
   </td>
