...
<tr>
<td>
<code>agentOwnLogs</code> <B>[Required]</B>
</td>
<td>
<a href="https://pkg.go.dev/github.com/odigos-io/odigos/common/api/instrumentationrules#AgentOwnLogs"><code>common/api/instrumentationrules.AgentOwnLogs</code></a>
</td>
<td>
