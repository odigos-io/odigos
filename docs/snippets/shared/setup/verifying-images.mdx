...
$ DIGEST=$(docker buildx imagetools inspect "${IMG}:v1.35.0" --format '{{.Manifest.Digest}}')
$ echo "$DIGEST"
sha256:f46fa614790877f65a1153078ec294fb41ab718dc0e6bd3c9a80196d170b2a25
...
[{"critical":{"identity":{"docker-reference":"us-central1-docker.pkg.dev/odigos-cloud/components/odigos-scheduler"},
