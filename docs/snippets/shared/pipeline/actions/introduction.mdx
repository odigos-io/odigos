...
Transformation Actions modify trace data to improve usability and reduce cardinality before export.
  - [URL Templatization](../../pipeline/actions/transformation/urltemplatization)
