...
If you prefer to use kubectl or GitOps to manage your Kubernetes workloads, you can set the `service.name` attribute by updating the corresponding Source.
