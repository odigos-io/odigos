...
- Apply [tail sampling](./actions/sampling/head-and-tail-sampling) based on the Odigos [sampling rules](./actions/sampling/rules/overview) to reduce the volume of data sent to the destinations.
