...
- Apply [tail sampling](./sampling/head-and-tail-sampling) based on the Odigos [sampling rules](./sampling/rules/overview) to reduce the volume of data sent to the destinations.
