...
<Note>
  ...
  - **K8s Agent**: [Continuous Profiling overview](https://enterprise.docs.odigos.io/enterprise/instrumentations/profiling/overview) and [getting started](https://enterprise.docs.odigos.io/enterprise/instrumentations/profiling/getting-started)
  - **VM Agent**: [Continuous Profiling overview](https://enterprise.docs.odigos.io/vmagent/instrumentations/profiling/overview) and [getting started](https://enterprise.docs.odigos.io/vmagent/instrumentations/profiling/getting-started)
</Note>
