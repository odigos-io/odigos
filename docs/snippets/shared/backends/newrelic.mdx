...
<Frame>
  <img src="/snippets/shared/backends/images/newrelic1.png" alt="New Relic API keys" />
</Frame>

For key type select **Ingest - License**, give a name to your key and press **Create a key**.

<Frame>
  <img src="/snippets/shared/backends/images/newrelic2.png" alt="Create an API key screen in New Relic" />
</Frame>
