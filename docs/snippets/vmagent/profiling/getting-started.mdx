...
Turn on the eBPF profiles pipeline on **odigos-otelcol**. You can use `odictl` or edit `/var/lib/odigos-agent/config/config.yaml` directly.
...
<Tabs>
  ...
  <Tab title="YAML">
    Add to `/var/lib/odigos-agent/config/config.yaml`:
