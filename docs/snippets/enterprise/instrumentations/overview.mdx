...
<LanguagesCard
  ...
  golangDescription="Versions 1.17 - 1.26 are supported"
  javascriptUrl="/enterprise/instrumentations/nodejs/native"
  ...
  javaUrl="/enterprise/instrumentations/java/native"
