...
- [`reactor-netty-http`](https://central.sonatype.com/artifact/io.projectreactor.netty/reactor-netty-http) versions `>=1.0.0`. Reactor Netty HTTP client used by Spring WebClient for non-blocking outbound HTTP calls
