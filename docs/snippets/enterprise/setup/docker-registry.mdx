...
docker pull p0xd21zf5r.registry.depot.dev/odigos/odigos-enterprise-instrumentor:$VERSION
...
docker pull p0xd21zf5r.registry.depot.dev/odigos/odigos-enterprise-odiglet:$VERSION
...
```bash
docker pull p0xd21zf5r.registry.depot.dev/odigos/odigos-enterprise-agents:$VERSION
```
...
docker pull --platform $PLATFORM p0xd21zf5r.registry.depot.dev/odigos/odigos-enterprise-instrumentor:$VERSION
...
docker pull --platform $PLATFORM p0xd21zf5r.registry.depot.dev/odigos/odigos-enterprise-odiglet:$VERSION
...
docker tag p0xd21zf5r.registry.depot.dev/odigos/odigos-enterprise-instrumentor:$VERSION $CUSTOM_DOCKER_REGISTRY/odigos-enterprise-instrumentor:$VERSION
...
docker tag p0xd21zf5r.registry.depot.dev/odigos/odigos-enterprise-odiglet:$VERSION $CUSTOM_DOCKER_REGISTRY/odigos-enterprise-odiglet:$VERSION
