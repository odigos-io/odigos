...
Manage Odigos Tower (Enterprise tier)

### Synopsis

Manage Odigos Tower backend and UI components used in enterprise deployments.
...
* [odigos pro central update-token](/cli/odigos_pro_central_update-token)	 - Update Odigos Tower on-prem token in the central namespace
