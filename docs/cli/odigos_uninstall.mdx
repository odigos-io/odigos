...
Note: If Odigos was installed using the CLI and the target namespace was created during installation, that namespace will also be deleted during uninstallation.
```
