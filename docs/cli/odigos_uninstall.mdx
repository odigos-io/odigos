...
```
  -h, --help         help for uninstall
      --in-cluster   Set to true if running inside a Kubernetes cluster (e.g. as a Helm hook job). Skips deletion of resources managed by Helm, which should be removed via 'helm uninstall'.
