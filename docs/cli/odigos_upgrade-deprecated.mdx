---
title: "odigos upgrade-deprecated"
sidebarTitle: "odigos upgrade-deprecated"
---
...
This command is deprecated. Please use `odigos install` instead which also upgrades the Odigos version in the cluster. which uses the Helm SDK under the hood.
