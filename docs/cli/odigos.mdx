...
* [odigos cleanup](/cli/odigos_cleanup)	 - Revert all the changes made by the `odigos install` command.
...
* [odigos install](/cli/odigos_install)	 - Install and upgrade Odigos using Helm SDK under the hood
* [odigos install-deprecated](/cli/odigos_install-deprecated)	 - Install Odigos in your kubernetes cluster.
...
* [odigos uninstall](/cli/odigos_uninstall)	 - Uninstall Odigos using Helm SDK under the hood
...
* [odigos upgrade](/cli/odigos_upgrade)	 - Upgrade Odigos using Helm SDK under the hood
* [odigos upgrade-deprecated](/cli/odigos_upgrade-deprecated)	 - Upgrade odigos version in your cluster.
