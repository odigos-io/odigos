---
title: "odigos update-offsets"
sidebarTitle: "odigos update-offsets"
---
...
This command pulls the latest available Go struct and field offsets information from Odigos.
...
```
      --default            revert to using the default offsets data shipped with Odigos
