...
<Note>
  If you are looking to connect Kubernetes clusters, see [Remote Clusters](/central/adding-connections/remote-clusters).
...
<Tabs>
  <Tab title="odictl">
    ...
    <Steps>
      ...
      <Step title="Navigate to the Central section">
        Use the arrow keys or mouse to navigate to the Central section on the left side of the screen.

        <img 
          src="../../../images/central/vmagent/odictl-central.png" 
          alt="odictl Central screen"
          style={{    
            width: "700px",
            height: "auto",
            display: "block",
      ...
      <Step title="Configure Central settings">
        ...
        <ParamField path="central.agent_name" type="string">
        ...
        <img 
          src="../../../images/central/vmagent/odictl-central-configured.png" 
          alt="odictl Central screen"
          style={{    
            width: "700px",
            height: "auto",
  ...
  <Tab title="YAML">
    ...
    <Steps>
      <Step title="Navigate to the /var/lib/odigos-agent/config folder">
    
        ```shell
        cd /var/lib/odigos-agent/config
        ```
