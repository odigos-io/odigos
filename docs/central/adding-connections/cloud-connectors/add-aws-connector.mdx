  ...
  <Step title="Choose access level">
    ...
    <Tabs defaultTabIndex="1">
      ...
      <Tab title="Discovery + instrumentation">
        ...
        Lambda instrumentation also requires an [OTLP destination](/central/adding-connections/cloud-connectors/instrument-workloads) after the connector is online.
      </Tab>
      <Tab title="Custom">
