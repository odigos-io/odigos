...
Lambda and Cloud Run support OTLP destinations only. For more information, see [Telemetry export](/central/adding-connections/cloud-connectors/overview#telemetry-export).
