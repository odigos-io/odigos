...
In most setups the endpoint is a **regional collector** in your cloud account (or another collector/backend those workloads can reach), which then forwards telemetry to your observability destinations. See [Instrument workloads](/central/adding-connections/cloud-connectors/instrument-workloads).
