...
AWS Lambda Ruby supports OTLP HTTP only. See [Telemetry export](#telemetry-export) for destination protocol limits.
...
Lambda and Cloud Run support **OTLP destinations only**.
...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="google"
    href="/central/adding-connections/cloud-connectors/add-gcp-connector"
  >
