...
<Tabs>
  <Tab title="CLI">
    ...
    | `--set cloudConnectors.enabled` | `false` | Enable [Cloud Connectors](/central/adding-connections/cloud-connectors/enable) (controller, Postgres, CRD) |
...
See [Enable Cloud Connectors](/central/adding-connections/cloud-connectors/enable) for PostgreSQL settings, verification steps, and full values.
