---
title: "Avoid Health Checks"
description: "The \"Avoid Health Checks\" rule can be used to control the sampling of health check traces. Health checks are typically high-frequency, low-value traces that can clutter your trace data and increase costs."
sidebarTitle: "Avoid Health Checks"
icon: "heart-pulse"
---
...
<Warning>
  Before configuring **avoid health checks**, please note the following:
...
<Steps>
  <Step>
    ...
    spec:
      ruleName: "avoid health check traces"
      avoidHealthChecks:
        fractionToRecord: 0
    ```
  </Step>
