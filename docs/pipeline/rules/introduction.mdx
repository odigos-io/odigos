...
- [Custom Instrumentations](/pipeline/rules/custominstrumentation)
- [IgnoreHealthChecks](/pipeline/rules/ignorehealthchecks)
- [HeadSamplingFallbackFraction](/pipeline/rules/headsamplingfallbackfraction)
