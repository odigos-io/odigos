...
The following example demonstrates how to completely ignore health check traces from recording for all sources in the cluster where the agent supports head sampling.
