...
sidebarTitle: "Source Configuration"
icon: "gear"
---

## service.name

[`service.name`](https://opentelemetry.io/docs/specs/semconv/resource/#service) is a required and fundamental resource attribute that is reported in all telemetry data.
