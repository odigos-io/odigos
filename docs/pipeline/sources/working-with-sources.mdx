...
description: "Learn more about how Sources work and how to use them."
sidebarTitle: "Working with Sources"
icon: 'circle-check'
---
...
By default, the existence of a Source instructs Odigos to auto-instrument the relevant workload or namespace for that Source.
