...
See [Add Sources](/pipeline/sources/create) for a quick introduction to creating Sources, or see [Working with Sources](/pipeline/sources/working-with-sources)
for more details on how Sources work and recommendations for using them.
