...
- This action will delete selected attributes from spans, metric data points and log record but will not delete the entire span, metric data point or log record. If you wish to delete the object itself.
...
- While common for data to be recorded as attributes, notice that it can also be recorded into names or other fields, for which this action will not be effective.
