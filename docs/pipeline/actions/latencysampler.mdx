...
- By sampling traces exceeding a certain latency threshold, you can prioritize investigating those traces to pinpoint the root cause of slowdowns. This helps you identify performance bottlenecks and optimize your system for efficiency.
...
spec:
  ...
  disabled: true
  notes: "Example notes of latency sampler"
...
- `minimum_latency_threshold` (required): Sample anything great than minimum_latency_threshold

- `maximum_latency_threshold` (optional): Specifies the maximum latency in milliseconds; requests exceeding this limit are ignored.
