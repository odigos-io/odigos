...
Actions are a way to modify the OpenTelemetry data recored by Odigos Sources, before it is exported to your Odigos Destinations.
...
- [Insert Cluster Attributes](insertclusterattributes) - Add static cluster-scoped attributes to your data.

Odigos also supports adding OpenTelemetry processors with [kuberenetes CRDs](crd) which you can apply manually or through a GitOps workflow.
