---
title: "Error Sampler"
description: "Sample traces with status code ERROR."
...
The "Error Sampler" Odigos Action is a [Global Action](/pipeline/actions/introduction#scope-categories) that supports error sampling by filtering out non-error traces.
