---
title: "Introduction"
description: "Sampling Actions allow you to configure various types of sampling methods before exporting traces to your destinations."
