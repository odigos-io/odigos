---
title: "Insert Cluster Attribute"
sidebarTitle: "Insert Cluster Attribute"
---

The "Insert Cluster Attribute" Odigos Action can be used to add resource attributes 
...
The full list of options available for the "InsertClusterAttribute" action are:
