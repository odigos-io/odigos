...
If **Odigos is already installed**, you can create a new Datastream from the Overview page. Click the + button at the top-left (under the current Datastream views) and follow the same steps as in the setup phase.
</Tab>
