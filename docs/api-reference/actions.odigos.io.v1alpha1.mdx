...
## `AttributeBasedFiltersConfig` <a id="AttributeBasedFiltersConfig"></a>
...
<td>
   <p>Attributes is a map of attribute keys and values to filter on.
...
Note that for traces, this can lead to apparent &quot;gaps&quot; in a trace when matching spans are filtered.</p>
</td>
</tr>
</tbody>
</table>
