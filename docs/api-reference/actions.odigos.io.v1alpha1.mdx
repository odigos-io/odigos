...
## `K8sAttributes` <a id="K8sAttributes"></a>
    
<p>K8sAttributes allows adding an action to collect k8s attributes.</p>
...
<tr><td><code>apiVersion</code></td><td>string</td><td><code>/v1alpha1</code></td></tr>
<tr><td><code>kind</code></td><td>string</td><td><code>K8sAttributes</code></td></tr>
...
<tr>
<td>
<code>annotation</code> <B>[Required]</B>
</td>
<td>
<code>string</code>
</td>
...
<tr>
<td>
<code>metadataAttributes</code>
</td>
<td>
<code>[]string</code>
</td>
<td>
   <p>Specifies the list of metadata attributes to be extracted from the pod.
The attributes collected by default are:
k8s.namespace.name
k8s.pod.name
k8s.pod.uid
k8s.pod.start_time
k8s.deployment.name
k8s.node.name
To see all possible attributes see https://github.com/open-telemetry/opentelemetry-collector-contrib/tree/main/processor/k8sattributesprocessor</p>
</td>
</tr>
<tr>
<td>
...
<td>
   <p>Represents the observations of a k8sattirbutes' current state.
Known .status.conditions.type are: &quot;Available&quot;, &quot;Progressing&quot;</p>
</td>
</tr>
</tbody>
