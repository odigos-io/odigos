...
1 means all health checks traces will be recorded</p>
</td>
</tr>
</tbody>
</table>
...
if set, health checks are sampled regardless of any other configuration (head sampling at agent level, before traces are pushed into the collector pipeline)</p>
</td>
</tr>
</tbody>
</table>
