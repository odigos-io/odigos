...
<tr>
<td>
<code>ownTelemetryEnabled</code> <B>[Required]</B>
</td>
<td>
<code>bool</code>
</td>
<td>
   <p>wether to setup and collect own telemetry in the collector.
currently, it is used to send odigos own metrics to the odigos prometheus (internal metrics store).</p>
</td>
</tr>
<tr>
<td>
<code>ownMetricsScrapeInterval</code> <B>[Required]</B>
</td>
<td>
<code>string</code>
</td>
<td>
   <p>the interval at which odigos will scrape own metrics from itself if own telemetry is enabled.
...
<td>
   <p>CPUCapacity is the CPU capacity of the node</p>
</td>
</tr>
<tr>
<td>
...
<td>
   <p>MemoryCapacity is the memory capacity of the node</p>
</td>
</tr>
</tbody>
</table>
