...
<td>
<a href="https://pkg.go.dev/github.com/odigos-io/odigos/common/api/sampling#SpanSamplingAttributesConfiguration"><code>sampling.SpanSamplingAttributesConfiguration</code></a>
</td>
<td>
