...
<td>
   <p>This field is the directory on k8s host where logs can be found.
It is usually set to '/var/log' but can be set to any other directory (like '/mnt/var/log')</p>
</td>
</tr>
</tbody>
</table>
