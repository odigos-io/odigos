...
<p>InstrumentedApplication is the Schema for the instrumentedapplications API
Deprecated: in favour of InstrumentationConfig</p>
...
<p>InstrumentedApplicationSpec defines the desired state of InstrumentedApplication
Deprecated: in favour of InstrumentationConfig</p>
...
<p>InstrumentedApplicationStatus defines the observed state of InstrumentedApplication
Deprecated: in favour of InstrumentationConfig</p>
