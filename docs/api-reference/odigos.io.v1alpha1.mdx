...
<td>
<a href="#odigos-io-v1alpha1-Services"><code>[]Services</code></a>
</td>
<td>
   <p>limit this rule to specific services by name, namespace, language, etc.
...
<td>
   <p>limit the operation to specific services.
an empty list will match any service.
if multiple items are set, the operation match if any one matches
this relates to the &quot;ResourceAttributes&quot; part of a span.</p>
</td>
...
<tr>
<td>
<code>durationMsAtLeast</code> <B>[Required]</B>
</td>
<td>
<code>int</code>
</td>
...
if the list is empty - all services are matched.</p>
</td>
</tr>
<tr>
<td>
...
if unset, 0% of such the traces will be collected.</p>
</td>
</tr>
<tr>
<td>
...
<tr>
<td>
<code>noisyEndpoints</code> <B>[Required]</B>
</td>
<td>
...
## `Services` <a id="odigos-io-v1alpha1-Services"></a>
...
<p>define conditions to match specific services (containers) in the cluster.
a service matches, if ALL non empty fields match (AND semantics)</p>
<p>common patterns:</p>
<ul>
<li>Specific service by name (service.name)</li>
<li>Specific kubernetes workload by name (WorkloadNamespace + WorkloadKind + WorkloadName)</li>
<li>Specific container in a kubernetes workload (WorkloadNamespace + WorkloadKind + WorkloadName + ContainerName)</li>
<li>All services in a kubernetes namespace (WorkloadNamespace)</li>
<li>All services implemented in a specific programming language</li>
</ul>
