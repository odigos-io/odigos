...
<td>
   <p>the reconciler resolves which injection method to use for this container.
...
<li>&quot;pod-manifest&quot;: inject the runtime specific agent loading env vars (e.g PYTHONPATH, NODE_OPTIONS) as specified in the distro manifest.</li>
