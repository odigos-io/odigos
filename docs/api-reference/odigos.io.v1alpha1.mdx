...
<tr>
<td>
<code>secretFiles</code>
</td>
<td>
<a href="#odigos-io-v1alpha1-SecretFileConfig"><code>[]SecretFileConfig</code></a>
</td>
<td>
   <p>SecretFiles defines keys from the SecretEnvRef to mount as files alongside
any environment variable secrets.</p>
</td>
</tr>
<tr>
<td>
...
<td>
   <p>EnvVars defines environment variables to add to the Collector deployment.</p>
</td>
</tr>
</tbody>
</table>
...
## `SecretFileConfig` <a id="odigos-io-v1alpha1-SecretFileConfig"></a>
...
<tr>
<td>
<code>mountPath</code> <B>[Required]</B>
</td>
<td>
<code>string</code>
</td>
