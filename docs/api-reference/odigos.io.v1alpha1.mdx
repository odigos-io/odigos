...
- [DataStream](#odigos-io-v1alpha1-DataStream)
...
## `DataStream` <a id="odigos-io-v1alpha1-DataStream"></a>
    
<p>DataStream configures a group (or sub-pipeline) to export telemetry data from explicit sources to explicit destinations.</p>
...
<tr><td><code>apiVersion</code></td><td>string</td><td><code>odigos.io/v1alpha1</code></td></tr>
<tr><td><code>kind</code></td><td>string</td><td><code>DataStream</code></td></tr>
...
<td>
<a href="#odigos-io-v1alpha1-DataStreamSpec"><code>DataStreamSpec</code></a>
</td>
<td>
   <span class="text-muted">No description provided.</span>
   </td>
...
<td>
<a href="#odigos-io-v1alpha1-DataStreamStatus"><code>DataStreamStatus</code></a>
</td>
<td>
   <span class="text-muted">No description provided.</span>
   </td>
...
## `DataStreamSpec` <a id="odigos-io-v1alpha1-DataStreamSpec"></a>
...
<tr>
<td>
<code>streamName</code> <B>[Required]</B>
</td>
<td>
<code>string</code>
</td>
<td>
   <p>StreamName represents the name of the data stream.
This field is required upon creation and can be modified.</p>
</td>
</tr>
<tr>
<td>
...
<td>
   <p>Default indicates whether this data stream is the default stream for objects that did not specifiy a stream name.
This field is optional and can be modified.</p>
</td>
</tr>
</tbody>
</table>

## `DataStreamStatus` <a id="odigos-io-v1alpha1-DataStreamStatus"></a>
...
<td>
   <p>Represents the observations of a streams's current state.</p>
</td>
</tr>
</tbody>
</table>
