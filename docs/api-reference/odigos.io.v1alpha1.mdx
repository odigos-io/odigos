...
<td>
<a href="#odigos-io-v1alpha1-OperationMatcher"><code>OperationMatcher</code></a>
</td>
<td>
...
- [OperationMatcher](#odigos-io-v1alpha1-OperationMatcher)
...
<tr>
<td>
<code>recoveredFromRollbackAt</code> <B>[Required]</B>
</td>
<td>
<a href="https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.31/#time-v1-meta"><code>meta/v1.Time</code></a>
</td>
<td>
   <p>RecoveredFromRollbackAt is a timestamp propagated from the Source spec.
...
Setting a new timestamp on the Source triggers another recovery.</p>
</td>
</tr>
</tbody>
</table>
...
<td>
   <p>RecoveredFromRollbackAt records the last spec timestamp that was processed for rollback recovery.
When this matches IC.Spec.RecoveredFromRollbackAt, the recovery has been handled.</p>
</td>
</tr>
<tr>
<td>
...
## `NoisyOperationHttpClientMatcher` <a id="odigos-io-v1alpha1-NoisyOperationHttpClientMatcher"></a>
...
## `NoisyOperationHttpServerMatcher` <a id="odigos-io-v1alpha1-NoisyOperationHttpServerMatcher"></a>
...
<td>
<a href="#odigos-io-v1alpha1-NoisyOperationHttpServerMatcher"><code>NoisyOperationHttpServerMatcher</code></a>
</td>
<td>
   <p>match http server operations for noisy operations matching (only attributes available at span start time)</p>
</td>
...
<td>
<a href="#odigos-io-v1alpha1-NoisyOperationHttpClientMatcher"><code>NoisyOperationHttpClientMatcher</code></a>
</td>
<td>
   <p>match http client operations for noisy operations matching (only attributes available at span start time)</p>
</td>
</tr>
<tr>
<td>
...
## `OperationMatcher` <a id="odigos-io-v1alpha1-OperationMatcher"></a>
...
<tr>
<td>
<code>recoveredFromRollbackAt</code>
</td>
<td>
<a href="https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.31/#time-v1-meta"><code>meta/v1.Time</code></a>
</td>
<td>
   <p>RecoveredFromRollbackAt is a timestamp signal to recover from a rollback and retry instrumentation.
