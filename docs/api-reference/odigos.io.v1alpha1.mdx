...
<td>
<a href="#odigos-io-v1alpha1-SpanMetricsSettings"><code>SpanMetricsSettings</code></a>
</td>
<td>
...
<td>
<a href="#odigos-io-v1alpha1-HostMetricsSettings"><code>HostMetricsSettings</code></a>
</td>
<td>
...
<td>
<a href="#odigos-io-v1alpha1-KubeletStatsSettings"><code>KubeletStatsSettings</code></a>
</td>
<td>
...
<td>
   <p>EnableDataCompression is a feature that allows you to enable data compression before sending data to the Gateway collector.
...
## `HostMetricsSettings` <a id="odigos-io-v1alpha1-HostMetricsSettings"></a>
...
## `KubeletStatsSettings` <a id="odigos-io-v1alpha1-KubeletStatsSettings"></a>
...
<td>
   <p>default configuration for custom instrumentations, in case the instrumentation library does not provide a configuration.</p>
</td>
</tr>
</tbody>
</table>
...
## `SpanMetricsSettings` <a id="odigos-io-v1alpha1-SpanMetricsSettings"></a>
