...
<td>
   <p>Allows you to attach a meaningful name to the action for convenience. Odigos does not use or assume any meaning from this field.Allows you to attach a meaningful name to the rule for convenience. Odigos does not use or assume any meaning from this field.</p>
</td>
</tr>
<tr>
<td>
...
<tr>
<td>
<code>calculateUrlTemplate</code> <B>[Required]</B>
</td>
<td>
<code>actions.CalculateUrlTemplate</code>
</td>
<td>
   <p>enhance http span with calculated low-cardinality url templated value</p>
</td>
</tr>
</tbody>
</table>
