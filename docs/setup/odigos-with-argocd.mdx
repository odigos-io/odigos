...
This guide explains how to configure Argo CD to work alongside Odigos without overwriting custom labels, annotations, or other fields that Odigos injects into workloads. To achieve this, we’ll use the `ignoreDifferences` setting in Argo CD to prevent it from syncing specific fields added by Odigos.
...
If you are using the ***Odigos Enterprise version***, replace the `containers` ignore paths with the following entries:  
```yaml
- /spec/template/spec/containers/0/resources/limits/instrumentation.odigos.io~1dotnet-native-community
- /spec/template/spec/containers/0/resources/limits/instrumentation.odigos.io~1java-ebpf-enterprise
- /spec/template/spec/containers/0/resources/limits/instrumentation.odigos.io~1python-ebpf-enterprise
- /spec/template/spec/containers/0/resources/limits/instrumentation.odigos.io~1go-ebpf-enterprise
- /spec/template/spec/containers/0/resources/limits/instrumentation.odigos.io~1javascript-ebpf-enterprise
- /spec/template/spec/containers/0/resources/limits/instrumentation.odigos.io~1mysql-ebpf-enterprise
- /spec/template/spec/containers/0/resources/limits/instrumentation.odigos.io~1nginx-native-community
```
