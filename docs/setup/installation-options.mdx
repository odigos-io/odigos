...
<Tabs>
  ...
  <Tab title="Operator">
       ...
       Fill in the **On Prem Token** field with your Enterprise Token and select the **openshift enabled** box. This is all that is required for installation.  Filling in other custom fields may require additional configuration within Openshift.  
