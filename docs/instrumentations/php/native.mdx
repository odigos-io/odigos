...
- [`IO Filesystem`](https://www.php.net/manual/en/book.filesystem.php) versions `*`
<Warning>
  Only for PHP 8.2+
</Warning>
...
<Info>
  We're working on adding support for `laravel`, `wordpress` and `codeigniter` frameworks.
</Info>
...
- [`cakephp/cakephp`](https://packagist.org/packages/cakephp/cakephp) versions `>=4`
<Check>
  For all PHP versions
</Check>
- [`yiisoft/yii2`](https://packagist.org/packages/yiisoft/yii2) versions `>=2.0.13`
<Check>
  For all PHP versions
</Check>
