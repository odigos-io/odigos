...
3. This will generate the documentation for the new destination in the [`docs/destinations`](https://github.com/odigos-io/odigos/tree/main/docs/destinations) directory.
