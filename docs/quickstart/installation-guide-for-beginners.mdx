...
This is the end of the one-time installations and the following steps will be required every time:
    ...
    This command creates a new Kubernetes cluster named "odigos-demo".<br />
    You'll see a lot of text appear in the Terminal. This is normal. Wait until you see a message that says "Your Kubernetes control-plane has initialized successfully!" and the command prompt appears again.
