...
## [`Attribute`](#odigos-io-v1alpha1-Attribute)
...
<td>
<code>go.opentelemetry.io/otel/attribute.Key</code>
</td>
<td>
...
## [`CollectorGatewayConfiguration`](#odigos-io-v1alpha1-CollectorGatewayConfiguration)
...
## [`CollectorsGroupResourcesSettings`](#odigos-io-v1alpha1-CollectorsGroupResourcesSettings)
...
## [`CollectorsGroupRole`](#odigos-io-v1alpha1-CollectorsGroupRole)
...
## [`CollectorsGroupStatus`](#odigos-io-v1alpha1-CollectorsGroupStatus)
...
## [`ConfigOption`](#odigos-io-v1alpha1-ConfigOption)
...
<td>
<code>github.com/odigos-io/odigos/common.SpanKind</code>
</td>
<td>
   <span class="text-muted">No description provided.</span>
   </td>
...
<td>
<code>github.com/odigos-io/odigos/common.DestinationType</code>
</td>
<td>
   <span class="text-muted">No description provided.</span>
   </td>
...
## [`DestinationStatus`](#odigos-io-v1alpha1-DestinationStatus)
...
## [`EnvVar`](#odigos-io-v1alpha1-EnvVar)
...
<tr>
<td>
<code>config</code> <B>[Required]</B>
</td>
<td>
<a href="#odigos-io-v1alpha1-WorkloadInstrumentationConfig"><code>[]WorkloadInstrumentationConfig</code></a>
</td>
<td>
   <p>config for this workload.
the config is a list to allow for multiple config options and values to be applied.
the list is processed in order, and the first matching config is applied.</p>
</td>
</tr>
<tr>
<td>
...
## [`InstrumentationInstanceSpec`](#odigos-io-v1alpha1-InstrumentationInstanceSpec)
...
## [`InstrumentationLibrary`](#odigos-io-v1alpha1-InstrumentationLibrary)
...
<td>
<code>github.com/odigos-io/odigos/common.ProgrammingLanguage</code>
</td>
<td>
   <p>Language is the programming language of the library</p>
</td>
</tr>
<tr>
<td>
<code>instrumentationLibraryName</code> <B>[Required]</B>
</td>
<td>
<code>string</code>
</td>
<td>
   <p>InstrumentationLibraryName is the name of the instrumentation library</p>
</td>
</tr>
</tbody>
</table>
...
<td>
<code>github.com/odigos-io/odigos/api/odigos/v1alpha1/instrumentationrules.PayloadCollection</code>
</td>
<td>
   <span class="text-muted">No description provided.</span>
   </td>
...
<td>
<code>github.com/odigos-io/odigos/api/odigos/v1alpha1/instrumentationrules.CodeAttributes</code>
</td>
<td>
...
## [`InstrumentationLibraryConfigTraces`](#odigos-io-v1alpha1-InstrumentationLibraryConfigTraces)
...
## [`InstrumentationLibraryId`](#odigos-io-v1alpha1-InstrumentationLibraryId)
...
## [`InstrumentationLibraryType`](#odigos-io-v1alpha1-InstrumentationLibraryType)
...
## [`InstrumentationRuleSpec`](#odigos-io-v1alpha1-InstrumentationRuleSpec)
...
<td>
<code>github.com/odigos-io/odigos/api/odigos/v1alpha1/instrumentationrules.OtelSdks</code>
</td>
<td>
...
## [`InstrumentationRuleStatus`](#odigos-io-v1alpha1-InstrumentationRuleStatus)
...
## [`InstrumentedApplicationStatus`](#odigos-io-v1alpha1-InstrumentedApplicationStatus)
...
## [`Operator`](#odigos-io-v1alpha1-Operator)
...
## [`OtherAgent`](#odigos-io-v1alpha1-OtherAgent)
...
## [`ProcessingState`](#odigos-io-v1alpha1-ProcessingState)
...
## [`ProcessorStatus`](#odigos-io-v1alpha1-ProcessorStatus)
...
<td>
<code>github.com/odigos-io/odigos/common.LibCType</code>
</td>
<td>
   <span class="text-muted">No description provided.</span>
   </td>
...
## [`SourceStatus`](#odigos-io-v1alpha1-SourceStatus)
...
<td>
   <p>OptionKey is the name of the option
This value is transparent to the CRD and is passed as-is to the SDK.</p>
</td>
</tr>
<tr>
<td>
...
<td>
   <p>This option allow to specify the config option for a specific span kind
for example, only to client spans or only to server spans.
it the span kind is not specified, the option will apply to all spans.</p>
</td>
</tr>
<tr>
<td>
<code>optionValueBoolean</code> <B>[Required]</B>
</td>
<td>
<code>bool</code>
</td>
<td>
   <p>OptionValueBoolean is the boolean value of the option if it is a boolean</p>
</td>
</tr>
<tr>
<td>
...
<td>
<a href="#odigos-io-v1alpha1-InstrumentationLibrary"><code>[]InstrumentationLibrary</code></a>
</td>
<td>
   <p>a list of instrumentation libraries to apply this setting to
if a library is not in this list, the setting should not apply to it
and should be cleared.</p>
</td>
</tr>
</tbody>
</table>
