...
<Steps>
  ...
  <Step title="Choose access level">
    ...
    <img
      src="/images/cloud-connectors/gcp-access-level.png"
  ...
  <Step title="Setup credentials">
    ...
    <img
      src="/images/cloud-connectors/gcp-setup-credentials.png"
    ...
    <Tabs defaultTabIndex="1">
      <Tab title="Workload identity">
        ...
        <Info>
          A local or non-GKE Central cluster has no ambient GCP identity. Use
          **Service account key** instead.
        </Info>
      </Tab>
      <Tab title="Service account key">
        Use a JSON key for a dedicated service account. Prefer this for local Central (for example k3d) or any cluster without Workload Identity / ADC.
