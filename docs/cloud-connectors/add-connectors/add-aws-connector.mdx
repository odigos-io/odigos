...
Both `aws.lambda` and `aws.fargate-task` can be instrumented **Odigos-managed** (the connector applies and
maintains the change) or **self-managed** via your own CloudFormation, CDK, or Terraform — see
