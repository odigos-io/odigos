...
<Warning>
  Unlike Lambda, there's no Odigos CDK construct for Fargate. If you use CDK, you'll
  write the same task-definition changes using plain `aws-cdk-lib/aws-ecs` — see
  [AWS CDK](#aws-cdk) below.
</Warning>
