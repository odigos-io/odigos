...
<CardGroup cols={2}>
  ...
  <Card title="Instrument Fargate (CDK / CloudFormation)" icon="cubes" href="/cloud-connectors/aws/workloads/fargate/instrument">
...
<CardGroup cols={2}>
  ...
  <Card title="Odigos AWS CDK" icon="code" href="/cloud-connectors/aws/cdk/overview">
    Instrument from your own CDK app — both Lambda and Fargate.
  </Card>
</CardGroup>
