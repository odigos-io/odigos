...
| \* | namespaces<br />services<br />secrets<br />nodes<br />configmaps | \* | get<br />list<br />patch |
...
|---|---|---|---|
| odigos.io | instrumentationconfigs | \* | get<br />list<br />watch |
| apps | deployments | \* | list<br />watch |
...
| APIGroups | Resources | Resource Names | Verbs |
|---|---|---|---|
| \* | namespaces<br />configmaps<br />secrets | \* | get<br />list<br />patch<br />delete |
...
| \* | secrets | \* | get<br />list<br />watch |
| apps | deployments | \* | get<br />list<br />update |
