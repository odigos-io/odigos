...
| APIGroups | Resources | Resource Names | Verbs |
|---|---|---|---|
| \* | events<br />namespaces<br />namespaces/status<br />nodes<br />nodes/spec<br />pods<br />pods/status<br />replicationcontrollers<br />replicationcontrollers/status<br />resourcequotas<br />services | \* | get<br />list<br />watch |
| apps | daemonsets<br />deployments<br />replicasets<br />statefulsets | \* | get<br />list<br />watch |
| extensions | daemonsets<br />deployments<br />replicasets | \* | get<br />list<br />watch |
| batch | jobs<br />cronjobs | \* | get<br />list<br />watch |
| autoscaling | horizontalpodautoscalers | \* | get<br />list<br />watch |
