...
Custom eBPF-based instrumentations for Go and Java require [Odigos Enterprise](https://enterprise.docs.odigos.io/enterprise/pipeline/rules/custominstrumentation) (requires an enterprise API key).
